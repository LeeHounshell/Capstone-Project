 ...
 */
public class ActorsEpisodesColumns implements BaseColumns {
    public static final String TABLE_NAME = "actors_episodes";
    ...
    public static final String FIELD_ACTOR_ID = "actors_episodes__field_actor_id";
