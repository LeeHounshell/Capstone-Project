...
import com.harlie.radiotheater.radiomysterytheater.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private final RadioTheaterService mService;
    ...
    public MediaNotificationManager(RadioTheaterService service) throws RemoteException {
        mService = service;
        updateSessionToken();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case ACTION_STOP_CASTING:
                ...
                i.putExtra(RadioTheaterService.CMD_NAME, RadioTheaterService.CMD_STOP_CASTING);
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        ...
        openUI.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP);
    ...
    private Notification createNotification() {
        ...
        if (mController != null && mController.getExtras() != null) {
            String castName = mController.getExtras().getString(RadioTheaterService.EXTRA_CONNECTED_CAST);
            if (castName != null) {
